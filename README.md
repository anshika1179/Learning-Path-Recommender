...
Unlike basic recommenders, this project uses **LLM-powered agents**, **semantic search (RAG)**, and **collaborative reasoning** to build dynamic learning paths that evolve as you learn.
This isn't just a recommender — it's an intelligent learning companion.
